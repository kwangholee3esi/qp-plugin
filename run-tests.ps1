...
.PARAMETER Target
    Which suite to run: all (default), portfolio, scenario, model, or coverage.
...
[CmdletBinding()]
param(
    [ValidateSet('all', 'portfolio', 'scenario', 'model', 'coverage')]
    [string]$Target = 'all',
...
$suites = [ordered]@{
    portfolio = 'skills/write-portfolio-file/tests/run_tests.py'
    scenario  = 'skills/write-scenario-file/tests/run_tests.py'
    model     = 'skills/write-model-file/tests/run_tests.py'
